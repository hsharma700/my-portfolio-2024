        ...
        <div className="contact_options">
          <article className='contact_option'>
            <SiMinutemailer className='contact_option-icon'/>
              ...
              <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=himanshusharmaok@gmail.com" rel="noreferrer" target="_blank">Send a Mail</a>
          </article>
          <article className='contact_option'>
            <SiMinutemailer className='contact_option-icon'/>
              <h4>WhatsApp</h4>
              <h5>+917814541207</h5>
              <a href="https://api.whatsapp.com/send?phone=917814541207" rel="noreferrer" target="_blank">Send a Message</a>
          </article>
        </div>
